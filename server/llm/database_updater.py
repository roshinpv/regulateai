...
class DatabaseUpdater:
    ...
    def _process_regulations(self, regulations: List[Dict[str, Any]], results: Dict[str, Any],
        ...
        for mapping in mappings:
            try:
                ...
                if unit not in regulation.responsible_units:
                    ...
                    logger.info(
                        f"Successfully mapped regulation {mapping['regulation_id']} to unit {mapping['compliance_area']}")
