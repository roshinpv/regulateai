...
def load_settings() -> OpenAISettings:
    ...
    try:
        ...
        settings.OPENAI_BASE_URL = os.environ.get("OPENAI_BASE_URL", settings.OPENAI_BASE_URL)
        ...
        settings.OPENAI_FREQUENCY_PENALTY = float(
            os.environ.get("OPENAI_FREQUENCY_PENALTY", settings.OPENAI_FREQUENCY_PENALTY))
        settings.OPENAI_PRESENCE_PENALTY = float(
            os.environ.get("OPENAI_PRESENCE_PENALTY", settings.OPENAI_PRESENCE_PENALTY))
